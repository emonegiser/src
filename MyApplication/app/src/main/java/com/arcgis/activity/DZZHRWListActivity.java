...
//地质灾害巡查任务
public class DZZHRWListActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listdzzhrw);
        ...
        showList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(xcrwEntity!=null){
                    ...
                    toMapIntent.setClass(DZZHRWListActivity.this,MainMap7Activity.class);
                    Bundle bundle = new Bundle();
                    bundle.putSerializable("XCRW",xcrwEntity);
                    bundle.putString("PX",px);
                    bundle.putString("PY",py);
                    bundle.putString("TEXT",xcrwEntity.getRWBH());
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (keyCode == KeyEvent.KEYCODE_BACK && event.getRepeatCount() == 0) {
            DZZHRWListActivity.this.finish();
            return true;
        }
    ...
    public void onClick(View v) {
        ...
        switch(viewId){
            case R.id.mapBtn:
                ...
                toMap1Intent.setClass(DZZHRWListActivity.this,MainMap7Activity.class);
