...
//上报用地使用
public class MainMap3Activity extends Activity implements DrawEventListener,GetPolygonCoordsListener,View.OnClickListener {
    ...
    static MainMap3Activity instance;
...
//    private TextView mapImg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        instance=MainMap3Activity.this;

        dzsysdicEntityDao=new DZSYSDICEntityDao(this);

        if (isNetwork) {

            ArcGISTiledMapServiceLayer tiledMapServiceLayer = new ArcGISTiledMapServiceLayer(ConstantVar.IMAGEURL,null);
...
//        mapImg.setOnClickListener(this);
        ...
        this.drawTool = new DrawTool(this.mMapView,"MainMap3Activity");
        ...
        if(isNetwork){
            ...
            try {
                ...
                if(bppcStr!=null && !bppcStr.isEmpty()){
                    ...
                    ToastUtil.show(MainMap3Activity.this,"服务器无返回值");
                }
        ...
        {
            ToastUtil.show( MainMap3Activity.this,"定位当前位置 经度："+MyApp.getmGPSLon()+"  纬度："+MyApp.getmGPSLat());
            SharedPreferences sp = MainMap3Activity.this.getSharedPreferences("LOGIN_INFO",  MainMap3Activity.this.MODE_PRIVATE);
        ...
        mMapView.setOnLongPressListener(new OnLongPressListener() {
            ...
            public boolean onLongPress(float x, float y) {
                ...
                if (id != null) {
                    ...
                    mMapView.setOnTouchListener(new MyMapOnTouchListener(MainMap3Activity.this, mMapView));
                } else {
    ...
    public static MainMap3Activity getInstance(){
        if(instance!=null){
            return instance;
        }
        return null;
    ...
    public void handleLatLon(List<MercatorEntity> LatLonPoint_List) {
        ...
        progressdialog=new ProgressDialog(MainMap3Activity.this);
        ...
        if(LatLonPoint_List!=null && LatLonPoint_List.size()>0){
            ...
            ToastUtil.show(MainMap3Activity.this,coordStr);
            ...
            toAddKC.setClass(MainMap3Activity.this,SBYDAddActivity.class);
            startActivityForResult(toAddKC,MainMap3Activity.TOADDPAGE);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (resultCode) { //resultCode为回传的标记，我在B中回传的是RESULT_OK
            case RESULT_OK:
                if(requestCode==MainMap3Activity.TOADDPAGE){
    ...
    public void onClick(View v) {
        ...
        switch (viewID){
            case R.id.backtextview:
                MainMap3Activity.this.finish();
                break;
            case R.id.addpointTextView2:
                GraphicID=drawTool.activate(DrawTool.POLYGON);
                Log.i(tag,"GraphicID:"+GraphicID);
                ToastUtil.show(this,"在地图上点选一个多边形，双击结束");
//                addpointTextView.setText("确定编辑");
                break;
            case R.id.querypointTextView2:
                Intent intent=new Intent();
                intent.setClass(this,SBYDQueryActivity.class);
                startActivity(intent);
                break;
            case R.id.clearTextView2:
                AlertDialog.Builder builder = new AlertDialog.Builder(MainMap3Activity.this);
                ...
                builder.setPositiveButton("删除", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                        MainMap3Activity.this.drawLayer.removeAll();
                        MainMap3Activity.this.drawTool.deactivate();
                    }
                });
...
//                break;
    ...
    public class GetBPPCDataSync extends AsyncTask<String, Integer, String> {
        ...
        public GetBPPCDataSync() {
            ksoap=new KsoapValidateHttp(MainMap3Activity.this);
        }
...
//            ToastUtil.show(MainMap3Activity.this,"执行了onDragPointerMove方法,ID:"+GraphicID);
            ...
            if (editIndex<0) {//此时需要获取编辑的节点序号
                ...
                {
                    ToastUtil.show(MainMap3Activity.this,"请选择点进行编辑");
                }
            }
...
//          添加到list<MercatorEntity>中，执行handlelatlon方法，传递参数到添加上报报工地页面
            ...
            if (geometry!=null) {
                ...
                ToastUtil.show(MainMap3Activity.this,"图层不存在");
            }
